...
private:
    ...
    uint8_t _apduBuffer[64];
    
    /** Buffer for card responses */
    uint8_t _responseBuffer[64];
     ...
     * @return DesfireStatus Status code of the operation
     */
    DesfireStatus transmit(uint8_t command, const uint8_t *data, uint8_t dataLen, 
     ...
     */
    uint8_t buildAPDU(uint8_t cla, uint8_t ins, uint8_t p1, uint8_t p2,
